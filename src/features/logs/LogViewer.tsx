...
/** Extracted log table with filtering, stats, and 5 s polling. */
              ...
              return (
                <Fragment key={log.id}>
                  ...
                  >
                    ...
                    <td className="px-3 py-2 min-w-0">
                      <div className="truncate" title={log.token_name || log.access_key_name || undefined}>
                        {log.token_name || log.access_key_name || <span className="text-muted-foreground">-</span>}
                      </div>
                    </td>
                          ...
                          {meta ? (
                            <div className="grid gap-1 rounded bg-background/60 p-2 text-muted-foreground">
                              ...
                              {meta.stream_end_reason ? (
                                <div>
                                  <span className="font-medium">{t("log.streamEndReason")}:</span>{" "}
                                  {meta.stream_end_reason}
                                </div>
                              ) : null}
                            </div>
